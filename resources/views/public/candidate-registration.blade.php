...
<body style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); min-height: 100vh; padding: 20px 0;">
    <div class="wizard-container">
        <div class="wizard-header">
            <h2><i class="fas fa-clipboard-list me-2"></i>{{ $registrationTitle }}</h2>
        ...
        <div class="wizard-body">
            ...
            <form id="registrationForm" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-step active" id="formStep1">
                    <h5 class="section-title"><i class="fas fa-user me-2"></i>1. Candidate Profile</h5>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Candidate Full Name <span class="required">*</span></label>
                ...
                <div class="form-step" id="formStep2">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Candidate Mobile Number <span class="required">*</span></label>
                                <div class="row g-1">
                                    <div class="col-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Parent / Guardian Contact Number <span class="required">*</span></label>
                                <div class="row g-1">
                                    <div class="col-4">
                ...
                <div class="form-step" id="formStep3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Highest Qualification Complete <span class="required">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Technology Proficiency Level <span class="required">*</span></label>
                                <select class="form-control" name="technology_performance_category" required>
                                    <option value="">Select</option>
                                    <option value="excellent">Excellent</option>
                                    <option value="average">Average</option>
                                    <option value="needs_support">Requires Additional Support</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="form-step" id="formStep4">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="form-group">
                                <label class="form-label">Passport-Size Photograph <span class="required">*</span></label>
                                ...
                                <input type="file" id="passport_photo" name="passport_photo" accept=".jpg,.jpeg,.png" style="display: none;" required>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="file" id="adhar_front" name="adhar_front" accept=".pdf,.jpg,.jpeg,.png" style="display: none;" required>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="file" id="sslc_certificate" name="sslc_certificate" accept=".pdf,.jpg,.jpeg,.png" style="display: none;" required>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="form-group">
                                ...
                                <input type="file" id="other_document" name="other_document" accept=".pdf,.jpg,.jpeg,.png" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="message" rows="3" placeholder="Any additional information you would like to share..."></textarea>
                    </div>
                </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow">
                <div class="modal-body text-center py-5 px-4">
                    ...
                    <p class="text-muted mb-4" id="successModalMessage">Registration submitted successfully!</p>
    ...
    <script>
        ...
        function validateCurrentStep() {
            const step = document.getElementById('formStep' + currentStep);
            ...
            if (currentStep === totalSteps) {
                ...
                if (terms && !terms.checked) {
                    alert('Please accept the Declaration & Consent to submit.');
                    return false;
                }
            }
            return true;
        ...
        function setupFileUpload(inputId) {
            ...
            input.addEventListener('change', function() {
                ...
                if (file) {
                    ...
                    preview.innerHTML = '<div class="file-preview-item"><div><i class="fas fa-file"></i> ' + file.name + '</div><span class="text-danger" style="cursor:pointer" onclick="document.getElementById(\'' + inputId + '\').value=\'\'; document.getElementById(\'' + inputId + '_preview\').innerHTML=\'\'"><i class="fas fa-times"></i></span></div>';
                }
            });
        }

        ['passport_photo', 'adhar_front', 'sslc_certificate', 'other_document'].forEach(setupFileUpload);
        ...
        document.getElementById('registrationForm').addEventListener('submit', function(e) {
            ...
            .then(data => {
                if (data.success) {
                    ...
                    document.getElementById('successModalMessage').textContent = data.message || 'Registration submitted successfully!';
