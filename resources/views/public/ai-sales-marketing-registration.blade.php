...
<head>
    ...
    <title>AI-Integrated Sales & Marketing Registration</title>
    ...
    <style>
        ...
        .wizard-header {
            ...
            color: white; padding: 40px 30px; border-radius: 15px 15px 0 0; text-align: center;
        ...
        .wizard-body {
            background: white; padding: 50px 40px; border-radius: 0 0 15px 15px;
        ...
        .step-indicators { display: flex; justify-content: space-between; margin-top: 20px; flex-wrap: wrap; gap: 10px; }
        .step-indicator { display: flex; flex-direction: column; align-items: center; flex: 1; min-width: 70px; position: relative; }
        .step-indicator:not(:last-child)::after {
            content: ''; position: absolute; top: 15px; left: 60%; right: -40%; height: 2px;
        ...
        .step-circle {
            ...
            font-size: 14px; position: relative; z-index: 2; transition: all 0.3s ease;
        }
        ...
        .step-label { margin-top: 8px; font-size: 11px; color: #666; text-align: center; }
        ...
        .form-control {
            border: 2px solid #e9ecef; border-radius: 8px; padding: 12px 15px; font-size: 14px;
        ...
        .pre-filled-info {
            ...
            border: 1px solid #bbdefb; border-radius: 10px; padding: 20px; margin-bottom: 30px;
        }
        ...
        .natdemy-logo { max-height: 100px; max-width: 220px; object-fit: contain; opacity: 0.95; }
        .declaration-box {
            background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 10px;
            padding: 20px; margin-bottom: 20px;
        }
        .declaration-box h5 { font-size: 1rem; font-weight: 600; margin-bottom: 10px; }
        .declaration-box p { font-size: 0.95rem; color: #495057; margin-bottom: 0; line-height: 1.6; }
        @media (max-width: 768px) {
            .wizard-body { padding: 30px 20px; }
            .step-indicator:not(:last-child)::after { display: none; }
            .btn-wizard { width: 100%; margin-bottom: 10px; }
            .natdemy-logo { max-height: 80px; max-width: 160px; }
        }
    </style>
</head>
<body style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); min-height: 100vh; padding: 20px 0;">
    <div class="wizard-container">
        <div class="wizard-header">
            ...
            <h2><i class="fas fa-chart-line me-2"></i>AI-Integrated Sales & Marketing</h2>
            ...
            <form id="registrationForm" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-step active" id="formStep1">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Primary Contact Number <span class="required">*</span></label>
                                <div class="row">
                                    <div class="col-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Guardian's Contact Number <span class="required">*</span></label>
                                <div class="row">
                                    <div class="col-4">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @else
                                    <div class="alert alert-warning mb-0" data-course-type-warning="1">
                                        <i class="fas fa-exclamation-triangle me-2"></i>No course types are configured for this course yet. Please contact the institution.
                                    </div>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Stream / Specialization <span class="required">*</span></label>
                                @if($streamSpecializations->isNotEmpty())
                                    <select class="form-control" name="stream_specialization_id" id="stream_specialization_id" required>
                                        <option value="" disabled selected>Select Stream / Specialization</option>
                                        @foreach($streamSpecializations as $streamSpecialization)
                                            <option value="{{ $streamSpecialization->id }}">{{ $streamSpecialization->title }}</option>
                                        @endforeach
                                    </select>
                                @else
                                    <div class="alert alert-warning mb-0" data-stream-warning="1">
                                        <i class="fas fa-exclamation-triangle me-2"></i>No stream / specializations are configured for this course yet. Please contact the institution.
                                    </div>
                                @endif
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                @else
                                    <div class="alert alert-warning mb-0">
                                        <i class="fas fa-exclamation-triangle me-2"></i>No active mode of study is configured for this course.
                                    </div>
                                @endif
                            </div>
                        </div>
                        <div class="col-md-6">
                            @if($course && $course->is_offline && $offlinePlaces->isNotEmpty())
                            <div class="form-group" id="location_group" style="display: none;">
                                <label class="form-label">Branch / Learning Center <span class="required">*</span></label>
                                <select class="form-control" name="location" id="location">
                                    <option value="">Select Branch / Learning Center</option>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group" id="class_time_group" style="display: none;">
                                <label class="form-label">Class Timing <span class="required">*</span></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                @else
                                    <div class="alert alert-warning mb-0" data-batch-warning="1">
                                        <i class="fas fa-exclamation-triangle me-2"></i>No batches are configured for this course yet. Please contact the institution.
                                    </div>
                                @endif
                            </div>
                        </div>
                ...
                <div class="form-step" id="formStep3">
                    ...
                    <div class="form-group">
                        <label class="form-label">House / Building Name <span class="required">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Locality / Area <span class="required">*</span></label>
                ...
                {{-- Step 4: Documents, Message & Declaration --}}
                <div class="form-step" id="formStep4">
                    <h4 class="mb-4"><i class="fas fa-upload me-2"></i>Document Uploads</h4>
                    <p class="text-muted mb-4">Please upload clear scans or photos. Max file size: 2MB.</p>

                    @php
                        $uploadFields = [
                            ['id' => 'passport_photo', 'label' => 'Passport-Size Photograph', 'required' => true, 'accept' => '.jpg,.jpeg,.png', 'hint' => 'JPG, PNG'],
                            ['id' => 'adhar_front', 'label' => 'Aadhaar Card (Front Side)', 'required' => true, 'accept' => '.pdf,.jpg,.jpeg,.png', 'hint' => 'PDF, JPG, PNG'],
                            ['id' => 'adhar_back', 'label' => 'Aadhaar Card (Back Side)', 'required' => true, 'accept' => '.pdf,.jpg,.jpeg,.png', 'hint' => 'PDF, JPG, PNG'],
                            ['id' => 'sslc_certificate', 'label' => 'SSLC Certificate', 'required' => true, 'accept' => '.pdf,.jpg,.jpeg,.png', 'hint' => 'PDF, JPG, PNG'],
                            ['id' => 'plustwo_certificate', 'label' => 'Higher Secondary Certificate', 'required' => true, 'accept' => '.pdf,.jpg,.jpeg,.png', 'hint' => 'PDF, JPG, PNG'],
                            ['id' => 'ug_certificate', 'label' => 'Degree Certificate', 'required' => true, 'accept' => '.pdf,.jpg,.jpeg,.png', 'hint' => 'PDF, JPG, PNG'],
                            ['id' => 'other_document', 'label' => 'Other Documents', 'required' => false, 'accept' => '.pdf,.jpg,.jpeg,.png', 'hint' => 'PDF, JPG, PNG (Optional)'],
                            ['id' => 'signature', 'label' => 'Candidate Signature', 'required' => true, 'accept' => '.jpg,.jpeg,.png', 'hint' => 'JPG, PNG'],
                        ];
                    @endphp
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">{{ $field['label'] }} @if($field['required'])<span class="required">*</span>@endif</label>
                                <div class="file-upload-area" onclick="document.getElementById('{{ $field['id'] }}').click()">
                                    <i class="fas fa-cloud-upload-alt fa-2x text-muted mb-2"></i>
                                    <p class="mb-0">Click to upload or drag & drop</p>
                                    <small class="text-muted">{{ $field['hint'] }}</small>
                                </div>
                                <input type="file" id="{{ $field['id'] }}" name="{{ $field['id'] }}" accept="{{ $field['accept'] }}" @if($field['required']) required @endif style="display: none;">
                                <div class="file-preview" id="{{ $field['id'] }}_preview"></div>
                            </div>
                        </div>
                        @endforeach
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="message" rows="3" placeholder="Enter any additional information..."></textarea>
                    </div>

                    <div class="declaration-box">
                        <h5>Declaration</h5>
                        <p>I hereby declare that the information provided in this application form is true and accurate to the best of my knowledge. I understand that any incorrect or misleading information may result in the cancellation of my admission.</p>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between mt-4">
                    <button type="button" class="btn btn-outline-secondary btn-wizard" id="prevBtn" style="display: none;">
    ...
    <script>
        let currentStep = 1;
        const totalSteps = 4;
        const STORAGE_KEY = 'ai_sales_marketing_form_data';

        const requiredFileFields = [
            'passport_photo', 'adhar_front', 'adhar_back',
            'sslc_certificate', 'plustwo_certificate', 'ug_certificate', 'signature'
        ];

        const fileFieldLabels = {
            passport_photo: 'Passport-size photograph',
            adhar_front: 'Aadhaar card (front)',
            adhar_back: 'Aadhaar card (back)',
            sslc_certificate: 'SSLC certificate',
            plustwo_certificate: 'Higher secondary certificate',
            ug_certificate: 'Degree certificate',
        ...
        function saveFormData() {
            ...
            for (let [key, value] of formData.entries()) {
                if (key !== 'lead_id' && key !== '_token') data[key] = value;
            }
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            requiredFileFields.concat(['other_document']).forEach(setupFileUpload);
        });
        ...
        function updateStepDisplay() {
            ...
            if (typeof window.applyTermsCheckboxVisibility === 'function') {
                window.applyTermsCheckboxVisibility();
            }
        }
        ...
        function validateAcademicStep(stepEl) {
            const courseTypeWarning = stepEl.querySelector('[data-course-type-warning]');
            const courseTypeSelect = stepEl.querySelector('#course_type_id');
            if (courseTypeWarning || !courseTypeSelect) {
                showAlert('Please select Course Type. No course types are configured for this course yet — please contact the institution.', 'warning');
                return false;
            }
            if (!courseTypeSelect.value) {
                courseTypeSelect.focus();
                showAlert('Please select Course Type.', 'warning');
                return false;
            }

            const streamWarning = stepEl.querySelector('[data-stream-warning]');
            const streamSelect = stepEl.querySelector('#stream_specialization_id');
            if (streamWarning || !streamSelect) {
                showAlert('Please select Stream / Specialization. No options are configured for this course yet — please contact the institution.', 'warning');
                return false;
            }
            if (!streamSelect.value) {
                streamSelect.focus();
                showAlert('Please select Stream / Specialization.', 'warning');
                return false;
            }

            const programmeTypeSelect = stepEl.querySelector('#programme_type');
            if (!programmeTypeSelect || !programmeTypeSelect.value) {
                if (programmeTypeSelect) programmeTypeSelect.focus();
                showAlert('Please select Mode of Study.', 'warning');
                return false;
            }

            const locationSelect = stepEl.querySelector('#location');
            if (programmeTypeSelect.value === 'offline') {
                if (!locationSelect) {
                    showAlert('Branch / Learning Center is required for offline mode.', 'warning');
                    return false;
                }
                if (!locationSelect.value) {
                    locationSelect.focus();
                    showAlert('Please select Branch / Learning Center.', 'warning');
                    return false;
                }
            }

            const classTimeGroup = stepEl.querySelector('#class_time_group');
            const classTimeSelect = stepEl.querySelector('#class_time_id');
            if (classTimeGroup && classTimeGroup.style.display !== 'none' && classTimeSelect && classTimeSelect.hasAttribute('required')) {
                if (!classTimeSelect.value) {
                    classTimeSelect.focus();
                    showAlert('Please select Class Timing.', 'warning');
                    return false;
                }
            }

            const batchWarning = stepEl.querySelector('[data-batch-warning]');
            const batchSelect = stepEl.querySelector('#batch_id');
            if (batchWarning || !batchSelect) {
                showAlert('Please select Batch. No batches are configured for this course yet — please contact the institution.', 'warning');
                return false;
            }
            if (!batchSelect.value) {
                batchSelect.focus();
                showAlert('Please select Batch.', 'warning');
                return false;
            }
        ...
        function fetchClassTimes(courseId, classType) {
            ...
            classTimeSelect.innerHTML = '<option value="">Select Class Timing</option>';
                    ...
                    if (data && data.length > 0) {
                        ...
                        if (savedData) {
                            try {
                                ...
                                if (parsed.class_time_id) {
                                    classTimeSelect.value = parsed.class_time_id;
                                }
                            } catch (e) {}
                        }
                    } else {
        ...
        function validateCurrentStep() {
            ...
            if (!currentStepElement) {
                showAlert('Unable to validate the current step. Please refresh the page and try again.', 'danger');
                return false;
            }

            if (currentStepElement.id === 'formStep2') {
                return validateAcademicStep(currentStepElement);
            }
            ...
            if (currentStep === 4) {
                for (const fieldName of requiredFileFields) {
                    ...
                    if (field && (!field.files || field.files.length === 0)) {
                        showAlert(`Please upload the required file: ${fileFieldLabels[fieldName]}`, 'warning');
                        return false;
                    }
                }
            }
            ...
            for (const field of requiredFields) {
                ...
                if (field.type === 'radio') {
                    ...
                    const checked = currentStepElement.querySelector(`input[name="${field.name}"]:checked`);
                    if (!checked) {
                ...
                const value = field.tagName === 'SELECT' ? field.value : String(field.value || '').trim();
                if (!value) {
                    field.focus();
                    showAlert('Please fill in all required fields.', 'warning');
                    return false;
            ...
            if (uploadArea) {
                ...
                uploadArea.addEventListener('drop', function(e) {
                    ...
                    if (e.dataTransfer.files.length > 0) {
                        ...
                        handleFileUpload({ target: { files: e.dataTransfer.files } }, preview, inputId);
                    }
                });
            }
        }
        ...
        function handleFileUpload(event, preview, inputId) {
            ...
            const imageOnly = ['passport_photo', 'signature'].includes(inputId);
        ...
        document.getElementById('registrationForm').addEventListener('submit', function(e) {
            ...
            fetch('{{ route("public.lead.ai-sales-marketing.store") }}', {
                method: 'POST',
                body: formData,
                headers: {
