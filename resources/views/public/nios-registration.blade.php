...
<head>
    ...
    <title>National Institute of Open Schooling Registration</title>
...
<body style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); min-height: 100vh; padding: 20px 0;">
    <div class="wizard-container">
        <div class="wizard-header">
            ...
            <h2><i class="fas fa-graduation-cap me-2"></i>National Institute of Open Schooling Registration</h2>
