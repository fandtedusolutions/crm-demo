...
@section('title', 'Robo Vibe Converted Mentor List')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Robo Vibe Converted Mentor List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">Robo Vibe Mentor</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.robo-vibe-mentor-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.robo-vibe-mentor-converted-leads.index') }}" class="btn btn-secondary"><i class="ti ti-x"></i> Clear</a>
                        </div>
                    </div>
                </form>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card" data-mentor-update-url="{{ route('admin.robo-vibe-mentor-converted-leads.update-mentor-details', ['id' => '__ID__']) }}">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Robo Vibe Converted Mentor List</h5>
                @include('admin.converted-leads.partials.export-buttons', ['exportPage' => 'mentor-robo-vibe'])
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
...
$(document).ready(function() {
    ...
    var updateUrlBase = '{{ route("admin.robo-vibe-mentor-converted-leads.update-mentor-details", ":id") }}';
