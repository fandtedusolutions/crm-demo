        ...
        <div class="row align-items-center">
            ...
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">Certificate Course in Medical Coding Mentor</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <form method="GET" action="{{ route('admin.medical-coding-mentor-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.medical-coding-mentor-converted-leads.index') }}" class="btn btn-secondary">
    ...
    <div class="col-12">
        <div class="card" data-mentor-update-url="{{ route('admin.medical-coding-mentor-converted-leads.update-mentor-details', ['id' => '__ID__']) }}">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>Certificate Course in Medical Coding Mentor List</h5>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover data_table_basic" id="dataScienceMentorTable">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="66" class="text-center">No Certificate Course in Medical Coding Mentor records found</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div class="d-lg-none">
                    ...
                    <div class="text-center py-5">
                        <div class="text-muted">
                            ...
                            <h5>No Certificate Course in Medical Coding Mentor records found</h5>
    ...
    $(document).ready(function() {
        ...
        $(document).off('click.saveInline').on('click.saveInline', '.save-edit', function(e) {
            ...
            const updateUrl = isConvertedLeadField ?
                ...
                `/admin/medical-coding-mentor-converted-leads/${id}/update-mentor-details`;
