...
@section('title', 'Certificate Course in Medical Coding Converted Support List')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Certificate Course in Medical Coding Converted Support List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-end align-items-center gap-3">
                    <ul class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">Certificate Course in Medical Coding Converted Support List</li>
                    </ul>
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.support-medical-coding-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.support-medical-coding-converted-leads.index') }}" class="btn btn-secondary">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>Certificate Course in Medical Coding Converted Support List</h5>
                @include('admin.converted-leads.partials.export-buttons', ['exportPage' => 'support-medical-coding'])
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
                <div class="d-none d-lg-block">
                    <div class="table-responsive">
                        <table class="table table-hover data_table_basic" id="supportMedicalCodingTable">
                            <thead>
                                <tr>
                                    <th>SL No</th>
                                    <th>Support</th>
...
@include('admin.converted-leads.partials.support-flag-inline-scripts', ['supportUpdateUrl' => route('admin.support-medical-coding-converted-leads.update-support-details', ['id' => '__ID__'])])
@endsection
...
<style>
    ...
    #supportMedicalCodingTable thead th,
    #supportMedicalCodingTable tbody td {
        white-space: nowrap;
    }
    ...
    #supportMedicalCodingTable tbody tr:hover {
        background: #fafbff;
    }

    #supportMedicalCodingTable td .display-value {
        display: inline-block;
        max-width: 220px;
        overflow: hidden;
        text-overflow: ellipsis;
    ...
    #supportMedicalCodingTable .btn-group .btn {
        margin-right: 4px;
    }

    #supportMedicalCodingTable .btn-group .btn:last-child {
        margin-right: 0;
    }
</style>
@endpush
...
<script>
    $(document).ready(function() {
        ...
        $(document).off('click.saveInline').on('click.saveInline', '.save-edit', function(e) {
            ...
            $.ajax({
                url: `/admin/support-medical-coding-converted-leads/${id}/update-support-details`,
                method: 'POST',
                data: {
                    field: field,
                    value: value,
        ...
        function loadSubjectsForEdit($select, currentValue) {
            $.get('/api/subjects/by-course/3').done(function(list) {
