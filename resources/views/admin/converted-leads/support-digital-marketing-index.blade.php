...
@section('title', 'AI Integrated Digital Marketing Converted Support List')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">AI Integrated Digital Marketing Converted Support List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-end align-items-center gap-3">
                    <ul class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">AI Integrated Digital Marketing Converted Support List</li>
                    </ul>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>AI Integrated Digital Marketing Converted Support List</h5>
                @include('admin.converted-leads.partials.export-buttons', ['exportPage' => 'support-digital-marketing'])
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
