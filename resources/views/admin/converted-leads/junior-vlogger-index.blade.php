...
@section('title', 'CreateX AI Converted Leads')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">CreateX AI Converted Leads Management</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">CreateX AI</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Filter CreateX AI Converted Leads</h5>
            </div>
            <div class="card-body">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">CreateX AI Converted Leads List</h5>
                @include('admin.converted-leads.partials.export-buttons', ['exportPage' => 'junior-vlogger'])
            </div>
            <div class="card-body">
    ...
    @include('admin.converted-leads.partials.inline-course-flag-cell', ['convertedLead' => $convertedLead])
                                ...
                                @empty
                                <tr>
                                    <td colspan="23" class="text-center">No CreateX AI converted leads found</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div class="d-lg-none">
                    ...
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted mt-2">No CreateX AI converted leads found</p>
                    </div>
                    @endforelse
                </div>
            </div>
