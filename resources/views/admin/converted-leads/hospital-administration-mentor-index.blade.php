...
@section('title', 'Diploma in Hospital Administration Mentor List')
...
<style>
    ...
    #haMentorTable thead th,
    #haMentorTable tbody td { white-space: nowrap; }
    #haMentorTable thead th {
        position: sticky; top: 0; background: #f8f9fa; z-index: 1;
        box-shadow: 0 1px 0 #dee2e6;
    }
    #haMentorTable tbody tr:hover { background: #fafbff; }
    #haMentorTable td .display-value {
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Diploma in Hospital Administration Mentor List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">Hospital Administration Mentor</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.hospital-administration-mentor-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.hospital-administration-mentor-converted-leads.index') }}" class="btn btn-secondary"><i class="ti ti-x"></i> Clear</a>
                        </div>
                    </div>
                </form>
            </div>
...
<div class="row">
    <div class="col-12">
        <div class="card" data-mentor-update-url="{{ route('admin.hospital-administration-mentor-converted-leads.update-mentor-details', ['id' => '__ID__']) }}">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Diploma in Hospital Administration Mentor List</h5>
                @include('admin.converted-leads.partials.export-buttons', ['exportPage' => 'mentor-hospital-administration'])
            </div>
            <div class="card-body">
                <div class="d-none d-lg-block">
                    <div class="table-responsive">
                        <table class="table table-hover data_table_basic" id="haMentorTable">
                            @include('admin.converted-leads.partials.hospital-administration-mentor-table', [
                                'canEdit' => $canEdit,
...
$(document).ready(function() {
    var updateUrlBase = '{{ route("admin.hospital-administration-mentor-converted-leads.update-mentor-details", ":id") }}';
    var dateFields = @json(\App\Support\HospitalAdministrationMentorTrackColumns::dateFields());
    ...
    $(document).on('click', '#haMentorTable .edit-btn', function(e) {
        e.preventDefault();
        e.stopPropagation();
        ...
        $('#haMentorTable .inline-edit').not('.mentor-flag-field').removeClass('editing').find('.edit-form').remove();
        var html = '';
    ...
    $(document).on('click', '#haMentorTable .save-edit', function(e) {
        e.preventDefault();
        var $c = $(this).closest('.inline-edit');
        if ($c.hasClass('mentor-flag-field')) return;
        var field = $c.data('field');
    ...
    $(document).on('click', '#haMentorTable .cancel-edit', function(e) {
        e.preventDefault();
