...
@section('title', 'Board of Open Schooling and Skill Education Converted Faculty List')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Board of Open Schooling and Skill Education Converted Faculty List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-end align-items-center gap-3">
                    <ul class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">Board of Open Schooling and Skill Education Converted Faculty List</li>
                    </ul>
    ...
    <div class="col-12">
        <div class="card" data-mentor-update-url="{{ route('admin.faculty-bosse-converted-leads.update-mentor-details', ['id' => '__ID__']) }}">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>Board of Open Schooling and Skill Education Converted Faculty List</h5>
                @include('admin.converted-leads.partials.export-buttons', ['exportPage' => 'faculty-bosse'])
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
