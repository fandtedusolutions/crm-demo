...
@section('title', 'Robo Vibe Converted Leads')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Robo Vibe Converted Leads Management</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">Robo Vibe</li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Filter Robo Vibe Converted Leads</h5>
            </div>
            <div class="card-body">
                <form method="GET" action="{{ route('admin.robo-vibe-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            <div class="d-flex gap-2 flex-wrap align-items-end">
                                ...
                                <a href="{{ route('admin.robo-vibe-converted-leads.index') }}" class="btn btn-secondary"><i class="ti ti-x"></i> Clear</a>
                            </div>
                        </div>
                    </div>
                </form>
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Robo Vibe Converted Leads List</h5>
                @include('admin.converted-leads.partials.export-buttons', ['exportPage' => 'robo-vibe'])
            </div>
            <div class="card-body">
                <div class="d-none d-lg-block">
                    <div class="table-responsive">
                        <table class="table table-hover data_table_basic" id="roboVibeTable">
                            <thead>
                                <tr>
                                    <th>SL No</th>
                                    <th>Academic</th>
                            ...
                            <tbody>
                                ...
                                @php
                                    $leadDetailRoboVibe = $convertedLead->lead ? $convertedLead->lead->roboVibeStudentDetails : null;
    ...
    @include('admin.converted-leads.partials.inline-course-flag-cell', ['convertedLead' => $convertedLead])
                                    ...
                                    <td>
                                        @if($leadDetailRoboVibe && $leadDetailRoboVibe->classTime)
                                            @php
                                                $fromTime = \Carbon\Carbon::parse($leadDetailRoboVibe->classTime->from_time)->format('h:i A');
                                                $toTime = \Carbon\Carbon::parse($leadDetailRoboVibe->classTime->to_time)->format('h:i A');
                                            @endphp
                                            {{ $fromTime }} - {{ $toTime }}
                                        @else
                                            -
                                    ...
                                    <td>{{ $leadDetailRoboVibe && $leadDetailRoboVibe->medium_of_study ? ucfirst(str_replace('_', ' ', $leadDetailRoboVibe->medium_of_study)) : '-' }}</td>
                                    <td>{{ $leadDetailRoboVibe && $leadDetailRoboVibe->previous_qualification ? ucfirst(str_replace('_', ' ', $leadDetailRoboVibe->previous_qualification)) : '-' }}</td>
                                    <td>{{ $leadDetailRoboVibe && $leadDetailRoboVibe->technology_performance_category ? ucfirst(str_replace('_', ' ', $leadDetailRoboVibe->technology_performance_category)) : '-' }}</td>
                                    <td>
                                        <div class="inline-edit"
                                ...
                                @empty
                                <tr>
                                    <td colspan="23" class="text-center">No Robo Vibe converted leads found</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div class="d-lg-none">
                    ...
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted mt-2">No Robo Vibe converted leads found</p>
                    </div>
                    @endforelse
                </div>
            </div>
