...
@section('title', 'AI Integrated Digital Marketing Converted Leads')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">AI Integrated Digital Marketing Converted Leads Management</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">AI Integrated Digital Marketing</li>
                </ul>
            </div>
        </div>
    </div>
                ...
                <div class="d-lg-none">
                    ...
                    <div class="text-center py-5">
                        <div class="text-muted">
                            ...
                            <h5>No AI Integrated Digital Marketing converted leads found</h5>
