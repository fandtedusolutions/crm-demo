...
@section('title', 'AI-Integrated Video Editing Converted Leads')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">AI-Integrated Video Editing Converted Leads Management</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">AI-Integrated Video Editing</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.ai-integrated-video-editing-converted-leads.index') }}" id="filterForm" class="js-programme-scoped-dt-form">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.ai-integrated-video-editing-converted-leads.index') }}" class="btn btn-secondary">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>AI-Integrated Video Editing Converted Leads</h5>
                @include('admin.converted-leads.partials.export-buttons', ['exportPage' => 'ai-integrated-video-editing'])
            </div>
            <div class="card-body">
