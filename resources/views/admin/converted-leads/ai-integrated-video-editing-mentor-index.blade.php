...
@section('title', 'AI-Integrated Video Editing Mentor List')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">AI-Integrated Video Editing Mentor List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">AI-Integrated Video Editing Mentor</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.ai-integrated-video-editing-mentor-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.ai-integrated-video-editing-mentor-converted-leads.index') }}" class="btn btn-secondary">
...
<div class="row">
    <div class="col-12">
        <div class="card" data-mentor-update-url="{{ route('admin.ai-integrated-video-editing-mentor-converted-leads.update-mentor-details', ['id' => '__ID__']) }}">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>AI-Integrated Video Editing Mentor List</h5>
                @include('admin.converted-leads.partials.export-buttons', ['exportPage' => 'mentor-ai-integrated-video-editing'])
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover data_table_basic" id="dataScienceMentorTable">
                            ...
                            <tbody>
                                ...
                                @empty
                                <tr>
                                    <td colspan="66" class="text-center">No AI-Integrated Video Editing mentor records found</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
                ...
                <div class="d-lg-none">
                    ...
                    <div class="text-center py-5">
                        <div class="text-muted">
                            ...
                            <h5>No AI-Integrated Video Editing mentor records found</h5>
    ...
    $(document).ready(function() {
        ...
        $(document).off('click.saveInline').on('click.saveInline', '.save-edit', function(e) {
            ...
            const updateUrl = isConvertedLeadField ?
                ...
                `/admin/ai-integrated-video-editing-mentor-converted-leads/${id}/update-mentor-details`;
