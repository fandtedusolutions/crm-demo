...
@section('title', 'AI-Integrated Photography Converted Support List')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">AI-Integrated Photography Converted Support List</h5>
                </div>
            </div>
            <div class="col-md-6">
                <div class="d-flex justify-content-end align-items-center gap-3">
                    <ul class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item">AI-Integrated Photography Converted Support List</li>
                    </ul>
...
<div class="row mb-3">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form method="GET" action="{{ route('admin.support-ai-integrated-photography-converted-leads.index') }}" id="filterForm">
                    <div class="row g-3 align-items-end">
                        ...
                        <div class="col-12 col-sm-6 col-md-2">
                            ...
                            <a href="{{ route('admin.support-ai-integrated-photography-converted-leads.index') }}" class="btn btn-secondary">
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5>AI-Integrated Photography Converted Support List</h5>
                @include('admin.converted-leads.partials.export-buttons', ['exportPage' => 'support-ai-integrated-photography'])
            </div>
            <div class="card-body">
                <!-- Desktop Table View -->
...
@include('admin.converted-leads.partials.support-flag-inline-scripts', ['supportUpdateUrl' => route('admin.support-ai-integrated-photography-converted-leads.update-support-details', ['id' => '__ID__'])])
@endsection
...
<script>
    $(document).ready(function() {
        ...
        $(document).off('click.saveInline').on('click.saveInline', '.save-edit', function(e) {
            ...
            $.ajax({
                url: `/admin/support-ai-integrated-photography-converted-leads/${id}/update-support-details`,
                method: 'POST',
                data: {
                    field: field,
                    value: value,
