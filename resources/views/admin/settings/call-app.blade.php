...
@section('title', 'Call App Settings')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">Call App Settings</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">Call App</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">Call Tracker App Update Settings</h5>
            </div>
            <div class="card-body">
                <form id="callAppSettingsForm" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Upload Call Tracker APK (max 100 MB). Uploaded file takes priority over download link.</div>
                    </div>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary" id="saveCallAppSettingsBtn">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted small">The app calls this endpoint on launch to check for updates.</p>
...
<script>
$(function () {
    $('#callAppSettingsForm').on('submit', function (e) {
        e.preventDefault();

        const $btn = $('#saveCallAppSettingsBtn');
        ...
        $.ajax({
            url: '{{ route('admin.call-app.settings.update') }}',
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $('#removeApkBtn').on('click', function () {
        ...
        $.post('{{ route('admin.call-app.settings.remove-apk') }}', {
            _token: '{{ csrf_token() }}'
