...
@section('title', 'CRM App Settings')
        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="page-header-title">
                    <h5 class="m-b-10">CRM App Settings</h5>
                </div>
            </div>
            <div class="col-md-6">
                <ul class="breadcrumb d-flex justify-content-end">
                    ...
                    <li class="breadcrumb-item">CRM App</li>
                </ul>
            </div>
        </div>
    </div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0">CRM Mobile App Update Settings</h5>
            </div>
            <div class="card-body">
                <form id="crmAppSettingsForm" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="form-text">Upload CRM mobile app APK (max 100 MB). Uploaded file takes priority over download link.</div>
                    </div>
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary" id="saveCrmAppSettingsBtn">
    ...
    <div class="col-lg-4">
        <div class="card">
            ...
            <div class="card-body">
                <p class="text-muted small">The CRM app calls this endpoint on launch to check for updates.</p>
                <code class="d-block small mb-3">GET /api/v1/app/version?app_version=1.0.0</code>
...
<script>
$(function () {
    $('#crmAppSettingsForm').on('submit', function (e) {
        e.preventDefault();

        const $btn = $('#saveCrmAppSettingsBtn');
        ...
        $.ajax({
            url: '{{ route('admin.crm-app.settings.update') }}',
            method: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $('#removeApkBtn').on('click', function () {
        ...
        $.post('{{ route('admin.crm-app.settings.remove-apk') }}', {
            _token: '{{ csrf_token() }}'
