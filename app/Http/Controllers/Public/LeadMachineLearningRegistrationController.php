...
class LeadMachineLearningRegistrationController extends Controller
{
    public function showMachineLearningForm($leadId = null)
    {
        ...
        return view('public.machine-learning-registration', compact('subjects', 'batches', 'lead', 'countryCodes', 'classTimes', 'course', 'offlinePlaces', 'courseTypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        ], CourseOfflinePlaceSupport::locationValidationRules($course), CourseCourseTypeSupport::validationRules($course, 20)), [
