...
class LeadDigitalMarketingRegistrationController extends Controller
{
    public function showDigitalMarketingForm($leadId = null)
    {
        ...
        return view('public.digital-marketing-registration', compact('subjects', 'batches', 'lead', 'countryCodes', 'classTimes', 'course', 'offlinePlaces', 'courseTypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        ], CourseOfflinePlaceSupport::locationValidationRules($course), CourseCourseTypeSupport::validationRules($course, 11)), [
