...
class LeadGraphicDesigningRegistrationController extends Controller
{
    public function showGraphicDesigningForm($leadId = null)
    {
        ...
        return view('public.graphic-designing-registration', compact('subjects', 'batches', 'lead', 'countryCodes', 'classTimes', 'course', 'offlinePlaces', 'courseTypes'));
    }
    ...
    public function store(Request $request)
    {
        ...
        ], CourseOfflinePlaceSupport::locationValidationRules($course), CourseCourseTypeSupport::validationRules($course, 15)), [
