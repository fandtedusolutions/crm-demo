...
class PromptEngineeringFacultyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $activeFacultyRoute = 'admin.prompt-engineering-faculty-converted-leads.index';

        return view('admin.converted-leads.prompt-engineering-faculty-index', compact(
