...
abstract class BaseGraphicDesigningStyleMentorController extends Controller
{
    abstract protected function courseId(): int;

    abstract protected function mentorViewName(): string;

    abstract protected function updateMentorDetailsRouteName(): string;
    ...
    public function updateMentorDetails(Request $request, $id)
    {
        try {
            ...
            Log::error('Error updating mentor details (course ' . $this->courseId() . '): ' . $e->getMessage());
