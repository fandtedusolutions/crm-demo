...
class RoboVibeFacultyController extends Controller
{
    private const COURSE_ID = 33;

    /**
     * Display Robo Vibe Converted Mentor List (course_id = 33)
     */
    public function index(Request $request)
    {
        ...
        $query = ConvertedLead::with([
            ...
            'lead.team',
            'lead.team.detail',
            'lead.roboVibeStudentDetails.classTime',
            'course',
            'academicAssistant',
            'createdBy',
            'cancelledBy',
        ...
        $activeFacultyRoute = 'admin.robo-vibe-faculty-converted-leads.index';

        return view('admin.converted-leads.robo-vibe-faculty-index', compact(
    ...
    /**
     * Update mentor/details inline for Robo Vibe
     */
    public function updateMentorDetails(Request $request, $id)
    {
        try {
            ...
            Log::error('Error updating Robo Vibe mentor details: ' . $e->getMessage());
            return response()->json([
                'success' => false,
