...
class CallAppSettingService
{
    public const VERSION_KEY = 'call_app_version';
    public const FORCE_UPDATE_KEY = 'call_app_force_update';
    public const DOWNLOAD_URL_KEY = 'call_app_download_url';
    public const APK_PATH_KEY = 'call_app_apk_path';
