...
class CrmAppSettingService
{
    public const VERSION_KEY = 'crm_app_version';
    public const FORCE_UPDATE_KEY = 'crm_app_force_update';
    public const DOWNLOAD_URL_KEY = 'crm_app_download_url';
    public const APK_PATH_KEY = 'crm_app_apk_path';
