...
class PermissionHelper
{
    ...
    public static function has_permission_support_team($permission = '')
    {
        $permissions = [
            ...
            'admin/support-medical-coding-converted-leads/index',
            'admin/support-hospital-administration-converted-leads/index',
    ...
    public static function has_permission_faculty($permission = '')
    {
        $permissions = [
            ...
            'admin/hospital-administration-faculty-converted-leads/index',
