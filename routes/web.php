...
Route::middleware(['custom.auth', 'telecaller.tracking'])->group(function () {
    ...
    Route::get('followup-leads/data', [LeadController::class, 'getFollowupLeadsData'])->name('leads.followup.data');
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/reports/converted-leads-report/data', [App\Http\Controllers\ConvertedLeadsReportController::class, 'getData'])->name('reports.converted-leads-report.data');
